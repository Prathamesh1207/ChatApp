  ...
  return (
    <>
      <Box 
        ...
        alignItems='center'
        bg='white' p='5px 10px 5px 10px' borderWidth='5px'
      >
          ...
          <Text fontSize="2xl" fontFamily='Work sans'>ChatWave</Text>
      ...
      <Drawer placement='left' onClose={onClose} isOpen={isOpen}>
          <DrawerOverlay />
          <DrawerContent>
            <DrawerHeader borderBottomRadius='1px'>Search User</DrawerHeader>
            <DrawerBody>
